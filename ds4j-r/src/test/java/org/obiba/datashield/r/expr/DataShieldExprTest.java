...
public class DataShieldExprTest {
  ...
  private static final Map<String, String> tests = Collections.unmodifiableMap(Stream.of(
      ...
      new AbstractMap.SimpleEntry<>("A number, small, exponential notation, US style", "1.0e-03"),
      new AbstractMap.SimpleEntry<>("A number, large, exponential notation, US style [1]", "1.0e+03"),
      new AbstractMap.SimpleEntry<>("A number, large, exponential notation, US style [2]", "1.0e3"),
      new AbstractMap.SimpleEntry<>("A number, small, exponential notation, French style", "1.0E-03"),
      new AbstractMap.SimpleEntry<>("A number, large, exponential notation, French style [1]", "1.0E+03"),
      new AbstractMap.SimpleEntry<>("A number, large, exponential notation, French style [2]", "1.0E3"),
      new AbstractMap.SimpleEntry<>("An integer", "5L"),
      new AbstractMap.SimpleEntry<>("A negative number", "-0.43151402098822"),
      new AbstractMap.SimpleEntry<>("A negative number, small, exponential notation, US style", "-1.0e-03"),
      new AbstractMap.SimpleEntry<>("A negative number, large, exponential notation, US style [1]", "-1.0e+03"),
      new AbstractMap.SimpleEntry<>("A negative number, large, exponential notation, US style [2]", "-1.0e3"),
      new AbstractMap.SimpleEntry<>("A negative number, small, exponential notation, French style", "-1.0E-03"),
      new AbstractMap.SimpleEntry<>("A negative number, large, exponential notation, French style [1]", "-1.0E+03"),
      new AbstractMap.SimpleEntry<>("A negative number, large, exponential notation, French style [2]", "-1.0E3"),
